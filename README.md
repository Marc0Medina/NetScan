...
Este es un proyecto para escanear redes y obtener información de los dispositivos conectados. El escaneo de una red representa el primer paso para conocer las vulnerabilidades de la red. Se pretende conocer los hosts activos, sus puertos abiertos junto con su servicio para luego intentar un payload con matasploit y tomar el control total de un grupo de computadoras para instalarles un cryptojacker. Todo esto con fines educativos
